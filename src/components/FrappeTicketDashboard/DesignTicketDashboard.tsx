    ...
    return (
        <div className="space-y-6">
            ...
            <NewTicketDialog
                ...
                onTicketCreated={(t) => {
                    // rely on logic state directly
                    L.setSelectedTicket(null);
                    // inject into list optimistically
                    // (kept simple; you can move this into logic if you prefer)
                    // NOTE: we don't have setTickets exposed; refresh instead:
                    L.fetchTickets(false, 1);
                    if (L.totalTicketCount !== null) {
                        // no setter for count; re-fetch count
                    }
                }}
            />
