...
import {TooltipProvider} from "@/ui/components/tooltip.tsx";
import {toast} from "sonner";
import {type Theme, useTheme} from "@/app/providers";
import {ApiConfig, ApiConfigDialog,} from "@/shared/components/ApiDialog/ApiConfigDialog.tsx";
import {type TestConnectionResult} from "@/shared/types";
import {LoginDialog} from "@/shared/components/Login/LoginDialog.tsx";
import {TabsNav} from "@/shared/components/navigation/TabsNav.tsx";
import {AddViewMenu, type ViewItem,} from "@/shared/components/navigation/AddViewMenu.tsx";
import {ThemeMenu} from "@/shared/components/navigation/ThemeMenu.tsx";
import {ProfileMenu} from "@/shared/components/navigation/ProfileMenu.tsx";
import {
    BarChart3,
    Calendar,
    Code,
...
import {Dashboard, useCurrentDashboard, useDashboardStore, useOpenLoginDialog,} from "@/shared/store/GlobalStore.ts";
...
export function TopBar({
    ...
    const [apiConfig, setApiConfig] = useState<ApiConfig>({
        allowCookies: false, customCookies: "",
    ...
    const handleTestConnection = async (config: ApiConfig): Promise<TestConnectionResult> => {
        try {
            ...
            if (response.ok) {
                ...
                return { 
                    success: data && (Array.isArray(data.data) || data.message),
                    data 
                };
            }
